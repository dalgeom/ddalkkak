...
const 문제 = {
	id: 'tv-17',
	chip: '상식 퀴즈 · 한국사',
	제목: `다음 중 <b>'임진왜란 3대첩'</b>에<br>속하지 <b>않는</b> 전투는?`,
	보기: ['한산도대첩', '진주대첩', '행주대첩', '명량대첩'],
	정답: 3,
	해설: '3대첩은 이순신의 <b>한산도</b>, 김시민의 <b>진주</b>, 권율의 <b>행주</b>입니다.<br>명량도 이순신의 승리지만 <b>정유재란(1597)</b> 때의 전투입니다.',
	/** 파일 이름에 쓸 짧은 말 */
	슬러그: '임진왜란3대첩'
};
