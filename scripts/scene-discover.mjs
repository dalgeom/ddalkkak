...
// 22호는 처음 quot-rem(몫과 나머지 이어 쓰기, 은행 29번)으로 렌더했다가 올리기 전에 갈았다 —
// 흔한 퍼즐 유형이라 「내보내는 문제는 퀄리티 좋은 것만」(9/15 결정)에 못 미친다고 봤다.
// num-hidden-fraction은 둘째 줄에서 「더했는데 작아진다」로 머리가 멈추고, 지식도 흔한 유형도 아니다.
const 문제 = {
	id: 'num-hidden-fraction',
	chip: '숫자의 정체',
	제목: '덧셈이 이상합니다',
	줄: ['12 + 13 = 56', '14 + 14 = 12', '13 + 16 = 12'],
	물음좌: '12 + 16 =',
	답: '23',
	// 셋째 식까지 한 줄에 넣었더니 「→ 12.」만 다음 줄로 떨어졌다 — 두 식만 둔다
	규칙: '<b>두 자리 수를 분수로</b> 읽습니다 — 12는 1/2, 13은 1/3.<br>1/2 + 1/3 = 5/6 → 56, 1/4 + 1/4 = 1/2 → 12.<br>1/2 + 1/6 = 2/3 → <b>23</b>.',
	/** 파일 이름에 쓸 짧은 말 */
	슬러그: '숨은분수'
};
